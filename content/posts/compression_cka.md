...
tags:
  ...
  - compression
draft: true
description: Demonstrating how matrix multiplication via SVD can compress an image, and measure how much information (variance) and structure (CKA) are preserved as we reduce the number of components
---
